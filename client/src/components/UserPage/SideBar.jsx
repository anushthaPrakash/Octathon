...
function SideBar({ setItem }) {
    ...
    const {signOutWithGoogle} = useUserAuth();
        ...
        >
            ...
            >
                <div className="space-y-6 md:space-y-10 mt-10">
                    <h1 className="block font-bold text-sm md:text-xl text-center">
                        My Profile<span className="text-[#3C6255]">.</span>
                    </h1>
                    ...
                    <div id="menu" className="flex flex-col space-y-2">
                        ...
                        <div onClick={LogOut}
                            className="text-sm select-none font-medium text-gray-700 py-2 px-2 hover:bg-[#3C6255] hover:text-white hover:scale-105 rounded-md transition duration-150 ease-in-out"
                        >
                            <svg
                                className="w-6 h-6 fill-current inline-block"
                                fill="currentColor"
